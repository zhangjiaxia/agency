...
/* 4 */
/*!************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/pages.json ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 7 */
/*!*****************************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/pages.json?{"type":"style"} ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/login": { "navigationBarTitleText": "登录" }, "pages/extension/index": { "navigationBarTitleText": "推广" }, "pages/index/index": { "navigationBarTitleText": "工作台" }, "pages/extension/poster": { "navigationBarTitleText": "商城推广海报" }, "pages/extension/addteam": { "navigationBarTitleText": "加入我的战队" }, "pages/profit/index": { "navigationBarTitleText": "我的收益", "navigationBarBackgroundColor": "#5B8EF5", "navigationBarTextStyle": "white" }, "pages/index/customer": { "navigationBarTitleText": "联系客服" }, "pages/index/help": { "navigationBarTitleText": "帮助&FAQ" }, "pages/index/usercenter": { "navigationBarTitleText": "用户中心" }, "pages/team/index": { "navigationBarTitleText": "我的团队" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),
/* 8 */
/*!****************************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/pages.json?{"type":"stat"} ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__B9DB7CF" };exports.default = _default;
...
/* 12 */
/*!****************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/store/index.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    setLoginInfo: function setLoginInfo(state, newValue) {
      state.loginInfo = newValue;
    },
    setUserInfo: function setUserInfo(state, newValue) {
      state.userInfo = newValue;
    },
    setOpenId: function setOpenId(state, newValue) {
...
/* 17 */
/*!********************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/style/iconfont.css ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 24 */
/*!********************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/utils/interface.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request.js */ 25));
...
var localUrlTest = "http://39.97.247.179:8080"; //本地项目https://192.168.0.127
var baseUrlTest = "https://game.itaocow.com.cn"; //测试域名，平时开发用测试域名，例如39.97.247.179
var baseUrlFormal = "https://shop.itaocow.com.cn"; //正式域名，提交文件时要切换到正式域名，例如https://wxmini.etour.wangytech.com
var newTestUrl = "http://pro.gzzshd.com";
//const baseUrl = isFormal ? baseUrlFormal : baseUrlTest;
var baseUrl = newTestUrl;
...
var interfaceurl = {
  ...
  /**
      ...
      */
  login: function login(detail, successBack) {
    console.log('login');
    ...
    uni.login({
      success: function success(res) {
        if (res.code) {
          ...
          //这里直接用原生请求就行了
          uni.request({
            url: "".concat(baseUrl, "/mp/wxapi/session.do"),
            data: {
            ...
            success: function success(res) {
              ...
              _store.default.commit('setOpenId', loginResp.openId);
              _store.default.commit('updateToken', loginResp.token);
              _store.default.commit('setLoginInfo', loginResp);
              _store.default.commit('setUserInfo', detail.userInfo);
              if (successBack) {
                successBack();
              }
            },
  ...
  //获取登录授权sessin_key
  session: function session(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/session.do"), data: data, method: 'POST' }, false);},
  //代理登录
  agentLogin: function agentLogin(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/login.do"), data: data, method: 'POST' }, false);},
  //短信验证码
  send: function send(data) {return _request.default.request({ url: "".concat(baseUrl, "/msg/send.do"), data: data }, false);},
  //小程序推广码
  qrcode: function qrcode(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/getQrcode.do"), data: data, method: 'POST' }, false);},
  ...
  //授权获取手机号
  getMobile: function getMobile(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/auth/getMobile.do"), data: data, method: 'POST' });},
  //保存并返回用户信息
  storeUser: function storeUser(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/wxapi/storeUser.do"), data: data, method: 'POST' });},
  //工作台--今日数据
  dataByDay: function dataByDay(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/dataByDay.do"), data: data });},
  //工作台-邀请用户数
  extensionUser: function extensionUser(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/extensionUser.do"), data: data });},
  //工作台-佣金数据
  commissionByUser: function commissionByUser(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/commissionByUser.do"), data: data });},
  //工作台-消费数据
  consumption: function consumption(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/consumption.do"), data: data });},
  //我的收益
  income: function income(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/income.do"), data: data });},
  //收益明细
  commission: function commission(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/commission.do"), data: data, method: 'POST' });},
  //提现申请
  moneyApply: function moneyApply(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/cash/apply.do"), data: data, method: 'POST' });},
  //团队业绩
  teamCommission: function teamCommission(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/teamCommission.do"), data: data });},
  //团队成员
  teamUser: function teamUser(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/auth/teamUser.do"), data: data, method: 'POST' });},
  //推广团队
  teamShare: function teamShare(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/auth/agent/teamShare.do"), data: data });},
  //推广海报
  poster: function poster(data) {return _request.default.request({ url: "".concat(baseUrl, "/mp/poster/list.do"), data: data });},
  //加入站队（代理人）
  joinTeam: function joinTeam(data) {return _request.default.request({ url: "".concat(baseUrl, "/mpa/agent/jointeam.do"), data: data, method: 'POST' });} };var _default =
...
/* 25 */
/*!******************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/utils/request.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _interface = _interopRequireDefault(__webpack_require__(/*! ./interface.js */ 24));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //引入全局变量的token
...
var req = {
  ...
  /**
      ...
      * 返回值：[string]errMsg
      */
  errPicker: function errPicker(err) {
  ...
  /**
      ...
      */
  request: function request() {var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};var keepLogin = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    //从小程序本地缓存中获取token
    //let token = uni.getStorageSync('token')
    var token = _store.default.state.token;var
    ...
    var header = Object.assign({
      ...
      //若是登录(不需要token的)接口则token为空(Authorization)
    ...
    return new Promise(function (res, rej) {
      ...
      options, {
        ...
        success: function success(r) {
          var isSuccess = req.isHttpSuccess(r.statusCode);
          if (isSuccess) {// 成功的请求状态
            ...
            var err = {
              msg: "\u5C0F\u7A0B\u5E8F\u597D\u50CF\u51FA\u95EE\u9898\u4E86\uFF0C\u8BF7\u4E0E\u5BA2\u670D\u8054\u7CFB~\uFF08\u9519\u8BEF\u4EE3\u7801\uFF1A".concat(r.statusCode, "\uFF09"),
              detail: r };
...
/* 42 */
/*!*********************************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/components/u-charts/u-charts.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 51 */
/*!*****************************************************************!*\
  !*** D:/zsShop/MiniMallDistributor/utils/base64-arraybuffer.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
